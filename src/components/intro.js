  ...
  render () {
    return <div className="introWrapper">
      <div className="intro">
        ...
        <p>I mostly fly quadcopters that I build myself. If you are interested in joining the fun, you can find a lot of resources needed to learn how to build your own RC craft:
          <ul>
      ...
      <ul className="socialWrapper">
        <li className="social social-youtube"><a href="https://www.youtube.com/channel/UCydV5xyX9KKfXdMG3RlID_A"><img src={Youtube} /></a></li>
        <li className="social social-instagram"><a href="https://www.instagram.com/thisnamistaken/"><img src={Instagram} /></a></li>
      </ul>
    </div>
  }
}
